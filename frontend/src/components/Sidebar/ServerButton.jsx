  ...
  return (
    <div className="relative flex items-center justify-center w-full group">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onClick}
        className={`relative w-12 h-12 flex-shrink-0 flex items-center justify-center font-pixel font-bold text-lg transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] focus:outline-none overflow-hidden border rounded-[12px] ${
          isActive
            ? 'bg-vyre-accent text-vyre-bg border-vyre-accent shadow-[0_0_12px_rgba(16,185,129,0.4)]'
            : 'bg-vyre-secondary text-vyre-text border-vyre-border hover:bg-vyre-accent hover:text-vyre-bg hover:border-vyre-accent'
        }`}
      >
