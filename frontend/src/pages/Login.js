    ...
    >
      ...
      <PixelPanel className="p-8 w-full max-w-md animate-fade-in relative z-10 flex flex-col items-center">
        <div className="text-center mb-8">
          ...
          <p className="font-pixel text-[10px] text-vyre-muted uppercase tracking-widest mt-4">Welcome back</p>
        </div>
        <form onSubmit={handleSubmit} className="w-full space-y-4" autoComplete="off">
          ...
          >
            ...
            <span className="font-pixel text-[10px] tracking-wider uppercase">Continue with Google</span>
          </button>

          <p className="text-center font-pixel text-[10px] tracking-wider text-vyre-muted mt-6 uppercase">
            No account?{' '}
            <Link to="/register" className="text-vyre-accent hover:text-emerald-400 transition-colors">
              Create one
            </Link>
          </p>
        </form>
