      ...
      <PixelPanel className="p-8 w-full max-w-md animate-fade-in relative z-10 flex flex-col items-center">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold font-pixel text-vyre-accent uppercase tracking-widest">
            {step === 1 ? 'Join Vyre' : 'Verify'}
          </h1>
          <p className="font-pixel text-[10px] text-vyre-muted uppercase tracking-widest mt-4">
            {step === 1 ? 'Start your community' : 'Enter the code sent to your email'}
          </p>
        </div>
          ...
          {step === 1 ? (
            ...
            <>
              <input
                ...
                maxLength={6}
                className="input-minimal w-full font-medium text-center text-2xl tracking-[0.5em]"
                value={otp}
              ...
              <button
                type="button"
                onClick={() => setStep(1)}
                className="w-full py-3 uppercase tracking-wider font-pixel text-[10px] text-vyre-muted hover:text-vyre-text mt-2 transition-colors"
              >
                Back
              </button>
            </>
