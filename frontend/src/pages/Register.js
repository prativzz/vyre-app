    ...
    >
      ...
      <PixelPanel className="p-8 w-full max-w-md animate-fade-in relative z-10 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          {error && (
            <div className="bg-red-500/10 border border-red-500/20 text-red-400 font-pixel text-[10px] uppercase tracking-widest p-4 rounded-xl mb-6 text-center animate-shake">
              {error}
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-vyre-muted hover:text-vyre-text transition-colors"
              >
